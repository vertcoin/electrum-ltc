...
from electrum_vtc.util import base_units, NoDynamicFeeEstimates
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'mVTC')
    ...
    def on_start(self):
        ...
        # bind intent for vertcoin: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def init_ui(self):
        ...
        self.icon = "icons/electrum-vtc.png"
