...
try:
    import electrum_vtc
    from electrum_vtc.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    ...
    from electrum_vtc.util import print_error, to_string, UserCancelled
    ...
    def get_xpub(self, bip32_path, xtype):
        ...
        if reply:
            ...
            if xtype != 'standard' or constants.net.TESTNET:
                _, depth, fingerprint, child_number, c, cK = deserialize_xpub(xpub, net=constants.VertcoinMainnet)
