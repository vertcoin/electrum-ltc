...
from electrum_vtc.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Vertcoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Vertcoin mode")) from e
                raise e
